...
포스타입(postype.com)에서 키워드 "${query}"로 ${date} 기준 수집한 상위 ${compact.posts.length}개 작품 데이터를 분석해주세요.
...
[출력 형식 — 반드시 아래 구조의 JSON으로만 응답. 다른 텍스트 0]
{
  ...
  "synopsisHooks": [
    { "hook": "훅 종류 (예: 신분 차이, 회귀)", "frequency": "X/N개 작품", "note": "구체적 관찰" }
  ],
  "tagDistribution": [
    { "tag": "#태그명", "count": 숫자, "note": "" }
  ],
  "popularPairings": [
    { "pairing": "그룹/멤버", "evidence": "관련 키워드/태그/제목에서 찾은 근거" }
  ],
  "monetization": {
    "paidRatio": "X%",
    "freeRatio": "X%",
    "note": "유료 vs 무료의 패턴 (예: 유료작은 회차 수가 많음 등)"
  },
  "lengthPattern": {
    "avgWordCount": "X자 또는 데이터 부족",
    "avgChapters": "X회차 또는 데이터 부족",
    "note": ""
  },
  "topAuthors": [
    { "author": "작가명", "works": 숫자, "totalViews": 숫자 또는 null }
  ],
  "actionableInsights": [
    "구체적이고 실행 가능한 글쓰기 조언 1 (시리즈명/예시 인용)",
    "조언 2",
    "조언 3"
  ],
  "warnings": [
    "데이터 한계나 주의사항 (예: 19+ 본문 미접근, 표본 크기 등)"
  ]
}`;
}

...
window.atelierShop = (function () {
  ...
  const PLAN_DEL = [                         // 제목에 이 문자열이 있으면 삭제
    ...
    ['2026-10-03', 'GRASSI'],                    // 박물관 피로 + 토요일 15:00 모테트와 충돌
  ...
  const PLAN_TIME = [                         // [날짜, 제목조각, 시작, 끝]
    ...
    ['2026-10-03', 'Stay KooooK 체크인', '16:00', '16:30']        // 모테트 뒤로 미룸
  ];
  const PLAN_ADD = [
    ...
    { date: '2026-10-03', time: '17:00', end_time: '18:45',
      title: '🚤 칼하이네 운하 · 플라크비츠 산책', lat: 51.3303, lng: 12.3318,
      route_note: '시내 → Plagwitz 트램 약 15분',
      description: '★ 라이프치히의 진짜 얼굴. 19세기 방적·기계 공장지대가 운하를 끼고 남아 있고,\n' +
        '그 건물들이 지금은 카페·작업실·바로 바뀌었어. 운하 따라 다리를 건너며 걷는 게 핵심.\n' +
        '보트도 다니고, 현지인들은 자전거로 와. 상점이 닫는 날에도 아무 상관 없는 동네야.\n' +
        '⏰ 오늘 일몰 18:43 · 21°/11°. 해 질 무렵 물에 공장 벽돌이 비치는 게 제일 좋아.' }
  ];

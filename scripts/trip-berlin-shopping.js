...
window.atelierShop = (function () {
  ...
  const PLAN_DEL = [                         // 제목에 이 문자열이 있으면 삭제
    ['2026-10-01', '카스타니엔알레'],          // 내가 넣은 것 — 기존 하케셔마르크트(15:45~18:00)와 겹침
    ...
    ['2026-10-02', '저녁 (노이쾰른']            // 내가 넣은 것 — 기존 '미테 저녁'과 겹침
  ];
  // ★ 뒤집힌 시각은 '줄이는' 게 아니라 '되돌린다' — 값이 서로 바뀌어 들어간 것으로 보인다.
  //   유대인박물관(12:15~15:40)은 뒤집히지 않았으므로 건드리지 않는다.
  const PLAN_TIME = [                         // [날짜, 제목조각, 시작, 끝]
    ['2026-10-02', 'Father Carpenter', '09:30', '10:15'],        // 끝=시작(0분) 이던 것
    ['2026-10-02', '노이에 나치오날갈레리', '13:15', '14:30'],     // 14:30–13:15 을 뒤집음
    ['2026-10-02', '안드레아스 무르쿠디스', '14:00', '15:45'],     // 15:45–14:00 을 뒤집음
    ['2026-10-02', '파노라마풍크트', '14:40', '17:00']             // 17:00–14:40 을 뒤집음
  ];
  const PLAN_ADD = [

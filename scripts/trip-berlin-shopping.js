...
window.atelierShop = (function () {
  ...
  const PLAN_TIME = [                         // [날짜, 제목조각, 시작, 끝]
    ...
    ['2026-10-03', 'GRASSI', '16:05', '17:05'],                   // 1시간이면 충분 (누리 기준)
  ...
  const PLAN_ADD = [
    { date: '2026-10-04', time: '11:30', end_time: '12:20',
      ...
      description: '1914년 유리지붕 아케이드. 주철 구조에 유리를 얹었고, 지하에 괴테 파우스트의\n' +
        '무대가 된 500년 된 술집(아우어바흐 켈러)이 있어.\n' +
        '라이프치히 구시가는 이런 아케이드가 **그물처럼 얽혀** 있어서, 건물 안으로 들어갔다\n' +
        '다른 골목으로 나오는 식으로 도시를 관통할 수 있어 — 슈페크스 호프·한자하우스로 이어져.\n' +
        '⚠️ 일요일이라 상점은 닫혀 있지만 **아케이드 안은 지나다닐 수 있어.** 건축·인테리어만 보면 돼.\n' +
        '역까지 도보 10분이라 그대로 걸어가면 딱 맞아.' },
    ...
    { date: '2026-10-02', time: '18:25', end_time: '19:20',
      ...
      description: '★ 5/14 원안의 마지막이 이거였어 — 베를린이 3박→2박 되며 사라졌던 걸 되살림.\n' +
        '베를린에 **폭포는 여기 하나뿐**이야. 24m 가 언덕 비탈을 타고 내려와.\n' +
        '꼭대기 신켈 기념비까지 오르면 시내가 열려. 해 질 무렵이면 현지인들이\n' +
        '맥주랑 스피커 들고 비탈에 자리 잡아 — 관광지가 아니라 동네 공원이야.\n' +
        '⏰ 오늘 일몰 18:41. 폭포는 5월부터 도는데 10월엔 멈춰 있을 수도 있어(언덕 전망이 본 목적).' },

    { date: '2026-10-02', time: '19:35', end_time: '21:00',
      title: '🍽️ 저녁 — 베르크만슈트라세 (크로이츠베르크)', lat: 52.4902, lng: 13.3895,
      route_note: '빅토리아파크에서 도보 8분',
      description: '공원 바로 아래 거리. 식당·카페가 줄지어 있어 내려오면서 고르면 돼.\n숙소(미테)까지 U7→U8 약 25분.' },
    { date: '2026-10-03', time: '14:50', end_time: '15:00',
      title: '🧳 역 코인로커에 짐 (체크인은 나중에)', lat: 51.3447, lng: 12.3806,
    ...
    { date: '2026-10-03', time: '17:40', end_time: '18:50',
      ...
      description: '★ 라이프치히의 진짜 얼굴. 19세기 방적·기계 공장지대가 운하를 끼고 남아 있고,\n' +
        '그 건물들이 지금은 카페·작업실·바로 바뀌었어. 운하 따라 다리를 건너며 걷는 게 전부야 —\n' +
        '들어가서 보는 게 아니라 지나가며 보는 곳이라 상점이 닫는 날에도 아무 상관 없어.\n' +
        '보트도 다니고 현지인들은 자전거로 와.\n' +
        '⏰ 일몰 18:43 · 21°/11°. 해 질 무렵 물에 공장 벽돌이 비치는 게 제일 좋아.' }
  ];

...
window.atelierShop = (function () {
  ...
  const PLAN_TIME = [                         // [날짜, 제목조각, 시작, 끝]
    ...
    ['2026-10-03', 'GRASSI', '16:05', '18:00'],                   // 18:00 폐관 — 꽉 채워 쓴다
    ['2026-10-03', 'Stay KooooK 체크인', '18:20', '19:00']        // 모테트·GRASSI 뒤로 미룸
  ];
  const PLAN_ADD = [
    ...
    { date: '2026-10-03', time: '19:10', end_time: '19:25',
      title: '🧳 역에서 짐 찾아 숙소로', lat: 51.3447, lng: 12.3806,
      route_note: 'GRASSI → 중앙역 1.0km',
      description: '아까 코인로커에 넣어둔 짐 회수. 체크인하고 바로 저녁.' }
  ];

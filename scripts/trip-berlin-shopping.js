...
window.atelierShop = (function () {
  ...
  const PLAN_TIME = [                         // [날짜, 제목조각, 시작, 끝]
    ...
    ['2026-10-02', '유대인박물관 (리베스킨트', '12:45', '14:00'],  // 건물만 — 상설전 스킵
    ['2026-10-02', '점심 대충', '14:10', '14:50'],
    ['2026-10-02', '노이에 나치오날갈레리', '15:00', '16:00'],     // 14:30–13:15 뒤집힘 복구
    ['2026-10-02', '오라니엔슈트라세 + Voo', '16:20', '17:20'],
    ['2026-10-02', '오라니엔 → 노이쾰른', '17:20', '17:30'],
    ['2026-10-02', '노이쾰른 빈티지', '17:30', '18:20'],
  ...
  const PLAN_ADD = [
    ...
    { date: '2026-10-02', time: '18:30', end_time: '19:15',

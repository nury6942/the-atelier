...
(function(){
  ...
  function setSyncLabel(daily, demo){
    ...
    if (demo){
      el.innerHTML = '<span style="background:#f59e0b;color:white;padding:2px 6px;border-radius:4px;font-size: var(--font-size-tiny);font-weight:bold;letter-spacing:0.05em;margin-right:6px">DEMO</span>더미 데이터';

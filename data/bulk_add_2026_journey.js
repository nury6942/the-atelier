...
// 항공권이 9/25~10/4 → 10/4~10/12 로 변경되어 이 일정은 전부 무효입니다.
// 현재 유효한 스크립트: data/rebase_2026_journey_oct.js
// 이 파일을 실행하면 9월 일정이 되살아나 10월 일정과 뒤섞입니다.
// (기록 보존을 위해 삭제하지 않고 가드만 걸어둠)

(async function bulkAdd2026JourneyV3() {
  if (!confirm(
    '⛔ 이 스크립트는 폐기되었습니다 (DEPRECATED)\n\n' +
    '여행 날짜가 2026-09-25~10-04 → 2026-10-04~10-12 로 변경되어\n' +
    '이 안의 9월 일정은 전부 무효입니다.\n\n' +
    '실행하면 9월 일정이 되살아나 현재 10월 일정과 뒤섞입니다.\n\n' +
    '👉 대신 사용할 것: data/rebase_2026_journey_oct.js\n\n' +
    '그래도 실행하시겠습니까?'

...
(async function rebase2026V2PisaDescent() {
  ...
  const items = [
    ...
    N('2026-10-12','08:00','08:50',PZ,'🥐 몬테풀차노 마지막 조식'),
    P('2026-10-12','08:50','09:30',PZ,'🏨 PULCINELLA 체크아웃','짐 계단 내려 P1 주차장으로(내리막이라 수월). 출발.'),
    N('2026-10-12','09:30','10:35',PZ,'🚗 몬테풀차노 → 오르비에토 (약 1H 5M)','응회암 절벽 위 도시. Campo della Fiera 주차 → 푸니쿨라. A1 길목.'),

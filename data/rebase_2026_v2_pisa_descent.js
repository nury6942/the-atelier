...
(async function rebase2026V2PisaDescent() {
  ...
  const items = [
    ...
    N('2026-10-04','19:30','21:00',FF,'🏛️ 뢰머광장 산책 + ⭐꼭: Apfelwein','⭐이건 꼭 — 프랑크푸르트 사과주(Apfelwein), 여기 아니면 못 먹어. Sachsenhausen "Adolf Wagner" 선술집. 사과주 + Frankfurter Würstchen 또는 Grüne Soße. 일요일도 영업.'),
    ...
    N('2026-10-09','13:30','14:30',PZ,'🍝 시에나 점심 (가볍게)','배고프면 광장 근처 트라토리아서 Pici/Ribollita 하나, 아니면 아래 젤라또로 때워도 OK.'),
    N('2026-10-09','14:45','16:00',PZ,'🛍️ Via di Città 골목·샵 + ⭐꼭: 젤라또','부티크·가죽·도자기 + 공방·아틀리에. ⭐이건 꼭 — 이탈리아 젤라또는 한국이랑 급이 다름. Kopa Kabana(피스타치오) 또는 Grom. 걸으며 하나. 누리 골목.'),
    ...
    N('2026-10-10','12:00','13:00',PZ,'🧀 ⭐꼭: Pecorino di Pienza 시식','⭐이건 꼭 — 피엔차는 양젖치즈(Pecorino) 세계 성지. Corso Rossellino 치즈가게서 24개월 숙성 시식(대부분 무료/소액). 마음에 들면 진공포장 사서 귀국.'),
    N('2026-10-10','13:00','14:30',PZ,'🍝 ⭐꼭 제대로 한 끼: Latte di Luna (피엔차)','⭐이번 여행 "제대로 앉아 먹는 한 끼". 발도르차 대표 수타면 ★Pici al Ragù★ + 양고기. 피엔차 현지 맛집, 예약 권장(☎️0578-748606).'),
    ...
    N('2026-10-11','13:00','14:15',PZ,'🍷 몬탈치노 점심 (가볍게)','배고프면 Pinci 가볍게. ★여긴 먹기보다 브루넬로 와인이 포인트★ — 근데 운전하니까 시음은 딱 한 잔만(또는 시음 후 뱉기).'),
    ...
    N('2026-10-12','13:10','14:30',PZ,'🍝 ⭐꼭: 트러플 파스타 (오르비에토 마지막 점심)','⭐이건 꼭 — 움브리아=트러플 산지. ★Umbricelli al tartufo(트러플 파스타)★ 또는 멧돼지 라구. Trattoria del Moro Aronne. 마지막 이탈리아 점심이니 제대로.'),
  ...
  console.log('\n🍴 이건 꼭 먹어볼 것 (그 외 끼니는 대충):');
  console.log('  1. 🇩🇪 10/4 프랑크푸르트 — Apfelwein(사과주) + 소시지 @ Adolf Wagner');
  console.log('  2. 🍦 10/9 시에나 — 젤라또 (Kopa Kabana / Grom)');
  console.log('  3. 🧀 10/10 피엔차 — Pecorino di Pienza 치즈 시식');
  console.log('  4. 🍝 10/10 피엔차 — Pici al Ragù @ Latte di Luna ★제대로 한 끼★');
  console.log('  5. 🍝 10/12 오르비에토 — 트러플 파스타(Umbricelli al tartufo)');

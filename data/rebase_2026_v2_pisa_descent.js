...
//   · PULCINELLA 몬테풀차노  10/9~10/12 (3박) [신규, 아파트 통째 67㎡]
//
...
(async function rebase2026V2PisaDescent() {
  ...
  const CITY_PLAN = [
    ...
    { match:/pienza|피엔차|montepulciano|몬테풀차노|orcia/i, name:'Montepulciano, 시에나 이탈리아', start:'2026-10-09', end:'2026-10-12', nights:3, order:4, desc:'발도르차 거점(PULCINELLA). 몬테풀차노·피엔차·산퀴리코·몬탈치노·바뇨비뇨니 당일치기.' },
  ];
  if (confirm('1단계: 도시(Stops)를 재구성할까요?\n\n프랑크푸르트1박 · 베를린3박 · 시에나1박(신규) · 몬테풀차노3박\n(드레스덴은 이미 삭제됨)')) {
    try {
  ...
  // ═══ 4) 새 일정 ═══
  const FF='Frankfurt am Main, 독일', BL='Berlin, 독일', SI=SI_NAME, PZ='Montepulciano, 시에나 이탈리아';
  ...
  const items = [
    ...
    // ═══ Day 6 — 10/9 (금) 시에나 → 크레테세네시 → 몬테풀차노  [일몰 18:38] ═══
    ...
    P('2026-10-09','13:30','15:40',PZ,'🚗 시에나 → 크레테 세네시 → 몬테풀차노 (약 1H 40M, 경치길)','★발도르차 초록과 완전 다른 회색 점토 황무지★ 아시아노 방향 SP438. 차로 달리는 뷰 맛집 — 렌트카 살린 보람. 사진 정차. 남하해서 몬테풀차노로.'),
    N('2026-10-09','15:40','16:20',PZ,'🏨 PULCINELLA 체크인 (몬테풀차노, 3박)','⚠️ 신규 예약(무료취소 10/8까지). ★아파트 통째 67㎡ 2베드룸, 구시가 중심★ 49 Ruga di Fuori, 9.1점.\n⚠️ 입구 가파른 계단 + 자갈 오르막 — 호스트 Daniele에게 계단 수·짐 도움 사전 문의. 짐은 거실층에 두고 3박 내내 안 옮김. 주차 P1 포르타 알 프라토(하루 €10·밤 무료).'),
    N('2026-10-09','16:40','18:38',PZ,'🌅 Tempio di San Biagio 일몰 (몬테풀차노 옆)','★마을 밖 르네상스 그리스십자 교회(1518, Sangallo)★ 황금빛 사암이 일몰에 금색. 완벽한 중심대칭 평면. 숙소서 차 5분 — 도착 첫 저녁 딱.'),
    N('2026-10-09','19:00','20:30',PZ,'🍽️ 몬테풀차노 Corso 첫 저녁 (도보)','★차 두고 걸어서★ Corso 오르막 골목·와인바. 비노 노빌레 곁들여도 걸어 복귀.'),

    // ═══ Day 7 — 10/10 (토) 피엔차 + 몬테풀차노  [일몰 18:38] ═══
    N('2026-10-10','07:30','08:30',PZ,'☕ 몬테풀차노 조식','PULCINELLA 주방 있음(자가) 또는 Corso 카페 코르네토+에스프레소.'),
    N('2026-10-10','09:00','09:20',PZ,'🚗 피엔차 방면 이동 (약 19분)','오늘은 서쪽(피엔차·산 퀴리코) 당일치기. ⚠️ 피엔차 ZTL — 성벽 밖 주차 후 도보.'),
    N('2026-10-10','09:20','10:15',PZ,'⛪ Cappella di Vitaleta','아침 빛 최고. 입구 주차 후 도보 15분. ⚠️ 흙길 — 비 온 다음날 미끄러움.'),
    N('2026-10-10','10:15','12:00',PZ,'🏛️ 피엔차 골목 + Piazza Pio II','교황 비오2세의 "완벽한 도시"(유네스코). 르네상스 이상도시. Via dell\'Amore. 로컬 샵·치즈가게.'),
    ...
    N('2026-10-10','14:30','16:30',PZ,'🚶 산 퀴리코 도르치아 산책','Horti Leonini 정원 + 골목. 피엔차서 약 10분. 조용한 소도시.'),
    N('2026-10-10','16:30','18:38',PZ,'🌅 사이프러스 길 일몰 (SP146, 산 퀴리코 북쪽)','★토스카나 엽서의 그 사이프러스 길★ 황금빛 지그재그. 일몰 18:38. 차 세우고 사진. ⚠️ 비탈레타 흙길 주의.'),
    N('2026-10-10','18:45','19:20',PZ,'🚗 몬테풀차노 복귀 (약 30분)'),
    N('2026-10-10','19:30','21:00',PZ,'🍷 몬테풀차노 Corso 저녁 (도보) + Palazzo Contucci','★집이 몬테풀차노라 걸어서★ Corso 골목·와인숍. Palazzo Contucci 500년 오크통 셀러(⚠️ 10월 수확철, ☎️+39 0578 757006 사전확인). 비노 노빌레.'),

    // ═══ Day 8 — 10/11 (일) 몬탈치노 + 바뇨비뇨니  [일몰 18:37] ═══
    N('2026-10-11','07:30','08:30',PZ,'☕ 몬테풀차노 조식'),
    N('2026-10-11','09:00','09:50',PZ,'🚗 몬탈치노 드라이브 (약 50분)','⚠️ 성벽 밖 주차. Piazzale Fortezza 또는 Via Strozzi.'),
    ...
    N('2026-10-11','18:40','19:20',PZ,'🚗 몬테풀차노 복귀 (약 33분)'),
    N('2026-10-11','19:30','21:00',PZ,'🍷 토스카나 마지막 저녁 (몬테풀차노 도보) + 짐 정리','내일 출국. 페코리노 진공·와인 뽁뽁이 확인. ⚠️ 액체·와인 위탁수하물. ★캐리어 미리 싸두기 — 내일 아침 입구 계단 대비.'),

    // ═══ Day 9 — 10/12 (월) 몬테풀차노 → 오르비에토 → FCO → 귀국 ═══
    N('2026-10-12','08:30','09:30',PZ,'🥐 몬테풀차노 느긋한 마지막 조식','출국일이지만 시간 여유 많음. 서두를 필요 없이.'),
    N('2026-10-12','09:30','10:00',PZ,'🧳 짐 정리 + 체크아웃 (10:00)','온라인 체크인 미리 완료 → 공항에선 짐만 부치면 끝. 짐 주차장으로.'),
    N('2026-10-12','10:00','11:10',PZ,'🚗 몬테풀차노 → 오르비에토 (약 1H)','응회암 절벽 위 도시. Campo della Fiera 주차 → 푸니쿨라. A1 길목.'),
  ...
  await up(lodgings.find(r=>/pienza|피엔차|montepulciano|몬테풀차노|garage|바냐이아|바그나이아|아그리투리스모|corso|enrico|pulcinella/i.test(hay(r))),
    { title:'PULCINELLA appartamento tipico centro storico (몬테풀차노)', address:'49 Ruga di Fuori, 53045 Montepulciano SI', city:PZ,
      date:'2026-10-09', checkout_date:'2026-10-12', payment_status:'결제 예정',
      notes:"⚠️ 신규 예약(무료취소 10/8까지, 온라인결제 10/6까지 안 빠짐). ★아파트 통째 67㎡ 2베드룸, 구시가 중심★ 9.1점/99후기, 전용욕실 2개. 3박 €387≈₩654k.\n⚠️ 입구 가파른 계단 + 주차장서 자갈 오르막 4분 — 예약 후 부킹 메시지로 호스트 Daniele에게 계단 수·짐 도움 문의. 짐은 도착 때 거실층에 두고 3박 내내 안 옮김.\n주차: P1 포르타 알 프라토, 하루 €10·밤 무료(3박 ~€30)." }, '숙소·PULCINELLA 몬테풀차노 10/9~12');
  ...
  const TODO = [
    ...
    '③ PULCINELLA 몬테풀차노 — 10/9~10/12 ★신규★ (무료취소 10/8까지 / 예약 후 호스트에 계단·짐도움 문의)',
  ...
  alert('✅ v2 재구성 완료!\n\n· 피사 하강 루트 (시에나1박 → 몬테풀차노3박)\n· 데사우 삭제, 베를린 3박\n· 몬탈치노·크레테세네시 추가\n· 일정 ' + ok + '개 (실패 ' + fail + ')\n\n⚠️ 콘솔 체크리스트 11건 확인.\n특히 시에나·PULCINELLA는 매진 임박 — 무료취소로 지금 예약!\n\n새로고침하세요.');
})();
